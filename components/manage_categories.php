...
<section class="box-section">
    ...
    <div class="box-header">
        <h4 class="box-title">Manage Catagories</h4>
    </div>
    
    <a href="./components/create_categories.php" class="create-users">
    ...
    <table>
        ...
        <tr>
            ...
            <td>
                <a href="./components/edit_categories.php?id=<?php echo $result['id'] ?>" style="background-color: rgb(197, 212, 255);">
            ...
            <td>
                <a href="./functions/delete_categories.php?id=<?php echo $result['id'] ?>" style="background-color: rgb(255, 168, 168);">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" style="width: 24px; padding: 6px;">
