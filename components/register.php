<?php
    ...
    if (isset($_POST['register-submit'])) {
        ...
        if ($user["username"] == $username) {
            ...
            $result = $conn->query("INSERT INTO accounts (username, firstname, lastname, password, level) VALUES ('$username', '$firstname', '$lastname', '$passwordenc', 'user')");
...
<html lang="en">
    ...
    <body>
        ...
        <a href="../">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" style="width: 24px; padding: 12px;">
